        ...
        <div className="flex flex-col gap-7">
            ...
            <div className="w-2/12 xl:w-3/12">
              <div className="flex items-center gap-4">
                <div className="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full">
                  <img src="https://react-demo.tailadmin.com/assets/user-17-20ba354e.png" alt="User" />
                </div>
          ...
          <div className="flex items-center gap-3">
            <div className="w-2/12 xl:w-3/12">
              <div className="flex items-center gap-4">
                <div className="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full">
                  <img src="https://react-demo.tailadmin.com/assets/user-18-46ea1355.png" alt="User" />
                </div>
                <span className="hidden font-medium xl:!block">
                  Makenna Carder
                </span>
            ...
            <div className="w-4/12 2xsm:w-3/12 md:w-2/12 xl:w-1/12">
              <span className="inline-block rounded  py-0.5 px-2.5 text-sm font-medium bg-meta-3/[0.08] text-meta-3 ">
                Active
              </span>
            </div>
            <div className="hidden w-2/12 2xsm:!block md:w-1/12">
          ...
          <div className="flex items-center gap-3">
            <div className="w-2/12 xl:w-3/12">
              <div className="flex items-center gap-4">
                <div className="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full">
                  <img src="https://react-demo.tailadmin.com/assets/user-19-dddc7e47.png" alt="User" />
                </div>
                <span className="hidden font-medium xl:!block">
                  Talan Dokidis
                </span>
          ...
          <div className="flex items-center gap-3">
            <div className="w-2/12 xl:w-3/12">
              <div className="flex items-center gap-4">
                <div className="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full">
                  <img src="https://react-demo.tailadmin.com/assets/user-20-91948726.png" alt="User" />
                </div>
                <span className="hidden font-medium xl:!block">
                  Cheyenne Levin
                </span>
          ...
          <div className="flex items-center gap-3">
            <div className="w-2/12 xl:w-3/12">
              <div className="flex items-center gap-4">
                <div className="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full">
                  <img src="https://react-demo.tailadmin.com/assets/user-21-d1ccfaa7.png" alt="User" />
                </div>
                <span className="hidden font-medium xl:!block">
                  James Aminoff
                </span>
