        ...
        <div className="min-w-[1170px]">
          ...
          <div className="bg-white dark:bg-boxdark">
            ...
            <div className="grid grid-cols-12 border-t border-[#EEEEEE] px-5 py-4 dark:border-strokedark lg:px-7.5 2xl:px-11">
              ...
              <div className="col-span-2">
                <p className="text-[#637381] dark:text-bodydark">Member</p>
              </div>
              <div className="col-span-1">
                <button className="float-right text-primary">Edit</button>
              </div>
            ...
            <div className="grid grid-cols-12 border-t border-[#EEEEEE] px-5 py-4 dark:border-strokedark lg:px-7.5 2xl:px-11">
              ...
              <div className="col-span-2">
                <p className="text-[#637381] dark:text-bodydark">Moderator</p>
              </div>
              <div className="col-span-1">
                <button className="float-right text-primary">Edit</button>
              </div>
            ...
            <div className="grid grid-cols-12 border-t border-[#EEEEEE] px-5 py-4 dark:border-strokedark lg:px-7.5 2xl:px-11">
              ...
              <div className="col-span-2">
                <p className="text-[#637381] dark:text-bodydark">Admin</p>
              </div>
              <div className="col-span-1">
                <button className="float-right text-primary">Edit</button>
              </div>
            ...
            <div className="grid grid-cols-12 border-t border-[#EEEEEE] px-5 py-4 dark:border-strokedark lg:px-7.5 2xl:px-11">
              <div className="col-span-3">
                <p className="text-[#637381] dark:text-bodydark">Jhon Smith</p>
              </div>
              <div className="col-span-3">
                <p className="text-[#637381] dark:text-bodydark">
                  Regional Paradigm Technician
