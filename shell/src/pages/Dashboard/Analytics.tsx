    ...
    <DefaultLayout>
      <div className="2xl:gap-7.5 grid grid-cols-12 gap-4 md:gap-6">
        <div className="col-span-12">
          <MicrofrontendSlot className="contents" name="chart-four" />
        </div>
        <div className="col-span-12">
          <MicrofrontendSlot className="contents" name="card-two" />
        </div>
          ...
          <div className="space-y-2.5 border-t border-stroke p-4 dark:border-strokedark md:p-6 xl:p-7.5">
            <div className="items-center sm:flex">
              <div className="flex w-full max-w-42.5 items-center gap-3.5">
                <img
                  src="https://react-demo.tailadmin.com/assets/country-01-3ee58ff6.svg"
                  alt="usa"
                />
            ...
            <div className="items-center sm:flex">
              <div className="flex w-full max-w-42.5 items-center gap-3.5">
                <img
                  src="https://react-demo.tailadmin.com/assets/country-02-417f8bbf.svg"
                  alt="canada"
                />
            ...
            <div className="items-center sm:flex">
              <div className="flex w-full max-w-42.5 items-center gap-3.5">
                <img
                  src="https://react-demo.tailadmin.com/assets/country-03-b2eaf276.svg"
                  alt="france"
                />
            ...
            <div className="items-center sm:flex">
              <div className="flex w-full max-w-42.5 items-center gap-3.5">
                <img
                  src="https://react-demo.tailadmin.com/assets/country-04-98c1f4c9.svg"
                  alt="italy"
                />
            ...
            <div className="items-center sm:flex">
              <div className="flex w-full max-w-42.5 items-center gap-3.5">
                <img
                  src="https://react-demo.tailadmin.com/assets/country-05-32039880.svg"
                  alt="australia"
                />
                <p className="font-medium text-black dark:text-white">
                  Australia
            ...
            <div className="items-center sm:flex">
              <div className="flex w-full max-w-42.5 items-center gap-3.5">
                <img
                  src="https://react-demo.tailadmin.com/assets/country-06-df9d1b67.svg"
                  alt="india"
                />
        ...
        <div className="col-span-12 xl:col-span-7">
          <MicrofrontendSlot className="contents" name="table-two" />
        </div>
      </div>
    </DefaultLayout>
  );
