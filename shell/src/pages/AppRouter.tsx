...
import ECommerce from './Dashboard/ECommerce.tsx';
import Analytics from './Dashboard/Analytics.tsx';
import Marketing from './Dashboard/Marketing.tsx';
import CRM from './Dashboard/CRM.tsx';
    ...
    >
      <Routes>
        ...
        <Route
          ...
          element={
            <>
              <PageTitle title="Analytics | TailAdmin - Tailwind CSS Admin Dashboard Template" />
              <Analytics />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <PageTitle title="Marketing | TailAdmin - Tailwind CSS Admin Dashboard Template" />
              <Marketing />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <PageTitle title="CRM | TailAdmin - Tailwind CSS Admin Dashboard Template" />
              <CRM />
            </>
          }
        />
        <Route
          ...
          element={
            <>
              <PageTitle title="Stocks | TailAdmin - Tailwind CSS Admin Dashboard Template" />
              <Stocks />
            </>
          }
        />
