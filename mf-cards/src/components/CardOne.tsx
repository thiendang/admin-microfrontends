...
const CardOneItem: React.FC<CardOneProps> = ({
  title,
  total,
  rate,
  levelUp,
...
const CardOne = () => {
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-8">
      ...
      <CardOneItem title="Total Profit" total="$45,2K" rate="4.35%" levelUp>
        <svg
          className="fill-indigo-500 dark:fill-white"
          width="20"
          height="22"
      ...
      <CardOneItem title="Total Product" total="2.450" rate="2.59%" levelUp>
        <svg
          className="fill-indigo-500 dark:fill-white"
          width="22"
          height="22"
      ...
      <CardOneItem title="Total Users" total="3.456" rate="0.95%" levelDown>
        <svg
          className="fill-[#259ae6] dark:fill-white"
          width="22"
          height="18"
          viewBox="0 0 22 18"
          fill="none"
